                    ...
                    <div class="text-start">
                        <form method="POST" action="{{ url('product_store') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('content') is-invalid @enderror" name="content" id="product_content" rows="3"></textarea>
                                @error('content')
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-xl-6 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control @error('image') is-invalid @enderror" type="file" accept="image/*" name="image" id="productFile">
                                                @error('image')
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-xl-6 col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control @error('image') is-invalid @enderror" type="number" name="qty" id="qty">
                                                        @error('qty')
                                        ...
                                        <div class="col-lg-6 col-xl-6 col-md-6">
                                            ...
                                            <div class="mb-3 form-check">
                                                <input type="checkbox" class="form-check-input" name="auto_delivery"  id="auto_delivery" value="1">
                                                <label class="form-check-label" for="auto_delivery">Auto Delivery</label>
                                            </div>

                                            <div class="mb-3 form-check">
                                                <input type="checkbox" class="form-check-input" name="unlimited" id="unlimited" value="1">
