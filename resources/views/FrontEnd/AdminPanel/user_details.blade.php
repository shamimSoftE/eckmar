                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="user_type_dispute" @if($user->type == 2) checked @endif value="1"  id="dispute">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 mb-3">
                                            <div style=" display: flex; justify-content: space-evenly; ">
                                                <span> DOLLAR($) : <input type="text" name="balance_dollar" style=" border-radius: 5px; border-color: #1881504f; width: 35%; padding: 3px; "
                                ...
                                <div class="card-footer">
                                    <form class="g-3">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-4">
                                              <input type="number" class="form-control" id="user_ban" placeholder="Days" name="ban_user">
                                            </div>
                                            <div class="col-sm-2">
                                                <button type="submit" class="btn btn-sm btn-outline-danger mb-3">Ban</button>
                                            </div>
                                        </div>
                                      </form>
                                </div>
